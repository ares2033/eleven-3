      ...
      <div className="mb-16 grid grid-cols-2 gap-8 px-4 md:grid-cols-4 lg:px-48">
        {[
          ...
          >
            ...
            <h3 className={`mb-2 text-2xl font-light text-white md:text-3xl`}>
              {stat.value}
            </h3>
          ...
          <div key={progetto.id} className="group relative">
            <div className="flex h-full flex-col justify-between rounded-2xl border border-white bg-black p-8">
              ...
              <div className="mb-6 flex items-start justify-between">
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className={`text-sm text-white/60`}>{progetto.client}</p>
                  </div>
                </div>
                <span className={`text-xs text-white/50`}>{progetto.year}</span>
              </div>

              {/* Category Badge */}
              <div
                className={`mb-4 inline-block w-fit rounded-full border border-white/20 px-3 py-1 text-xs text-white`}
              >
                {progetto.category}
              </div>
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {progetto.technologies.map((tech, techIndex) => (
                    <span
                      key={techIndex}
                      className={`rounded-full border border-white/20 px-2 py-1 text-xs text-white/70`}
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="mb-6 grid grid-cols-2 gap-4 text-xs">
                <div>
                  <span className={`block font-medium text-white`}>DURATA</span>
                  <span className={`text-white/60`}>{progetto.duration}</span>
                </div>
                <div>
                  <span className={`block font-medium text-white`}>TEAM</span>
                  <span className={`text-white/60`}>{progetto.team}</span>
                </div>
              </div>
              ...
              <div>
                <Button
                  className={`w-full rounded-full border border-white/20 bg-transparent font-light text-white transition-all duration-300 hover:cursor-pointer hover:bg-white hover:text-black `}
                >
